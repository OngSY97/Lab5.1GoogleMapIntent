...
public class MainActivity extends AppCompatActivity {
    EditText editTextLon, editTextLat;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonShowMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lon = Double.parseDouble(editTextLat.getText().toString());
                //TODO passing lat and lon values to an Intent object
                Uri gmmIntentUri = Uri.parse("geo:"+ lat+","+lon+"?z=10").buildUpon()
                        .appendQueryParameter("q", "1st & Pike, Seattle").build();
